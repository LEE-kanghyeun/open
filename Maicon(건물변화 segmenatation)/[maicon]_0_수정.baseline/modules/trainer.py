...
class Trainer():
    ...
    def train(self, dataloader, epoch_index=0):
        ...
        # --------------------------------------------------------------- 
        # Eric
        # model save 1 epoch per each epoch
        #torch.save(self.model.state_dict(), "/mnt/e/01.Eric/02.Source/09.[Maicon]_Change_Dtection/0.baseline/results/train/model_{epoch_index}.pth")
