...
class DeepSpeech2(EncoderModel):
    ...
    def __init__(
        ...
        #VGG 이용시 좀더 성능이 좋다고 함
        #https://arxiv.org/pdf/2009.03092.pdf
...
def build_las(
    ...
    model = ListenAttendSpell(
        ...
        encoder_hidden_state_dim=512,
        decoder_hidden_state_dim=1024,
        # encoder_hidden_state_dim=256,
        # decoder_hidden_state_dim=512, #out of memory
        # encoder_hidden_state_dim=128,
        # decoder_hidden_state_dim=256, 
