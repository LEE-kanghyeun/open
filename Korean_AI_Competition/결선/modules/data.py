...
# validation 데이터양을 0.2 -> 0.1 로 줄임 (9/5 05:40) -> best score 나옴
# validation 데이터양을 0.1 -> 0.01 로 줄임 (9/6 06:57) -> best score 나옴
# las validation 데이터양을 0.2 -> 0.1 로 줄임 (9/15) -> best score 나옴
def split_dataset(config, transcripts_path: str, vocab: Vocabulary, valid_size=.01):
