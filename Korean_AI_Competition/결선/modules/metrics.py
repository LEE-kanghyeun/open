...
#from modules.hanspell import spell_checker
#from modules.symspellpy_ko import KoSymSpell, Verbosity
...
class CharacterErrorRate(ErrorRate):
    ...
    def metric(self, s1: str, s2: str):
        ...
        # comp = sym_spell.word_segmentation(s2, max_edit_distance=2)
        # print("교정 : "+comp.corrected_string)
        # if comp.corrected_string != s2 :
        #     print("교정됨")
        # #보정 
        # result = spell_checker.check(s2)
        # if result.result and result.errors !=0:
        #     print("보정 : "+result.checked)
        #     print("보정한 개수 : "+str(result.errors))
